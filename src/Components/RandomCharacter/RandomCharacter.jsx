    ...
    const generatedCharacter = [
        {
            ...
            devilFruit: "no devil fruit power. However, he has inhumane strength that delivers great power with each strike. He also possesses all 3 types of Haki, the Color of Arms, the Color of Observation, & the Color of Supreme King aka Conqueror's Haki.",
        ...
        },
        {
            ...
            description: "Chopper is a reindeer who ate the Human-Human Fruit, allowing him to transform into a human, deer hybrid. He serves as the doctor of the Straw Hat Pirates. He is known for his kind heart and strong desire to help others.",
            ...
            devilFruit: "no devil fruit power. However, she uses a three sectioned staff, known as the Clima-Tact, to manipulate the weather around her to create attacks. Some of her techniques include Mirage Tempo to create a fake illusions of her self and Thunderbolt Tempo to create a powerful lightning cloud.",
            ...
            devilFruit: "no devil fruit. However, due to the arduous training under the chef Zeff he gained extraordinary superhuman strength, speed, and agility. He also became a master at Black Leg Style, a form of martial arts that relies solely on dynamic & well-coordinated kicks.",
            ...
            devilFruit: "the Hana Hana no Mi or Flower-Flower Fruit, which allows her to replicate & sprout her body parts from any surface. She uses her ability to sprout multiples of her own body parts to extend her reach. For tactical approaches she can also spout an eye or ear in spaces to gather intelligence.",
            ...
            description: "Brook is the musician of the Straw Hats and is their second swordsman with Zoro. He was originally a member of the Rumbar Pirates then died and was resurrected through the power of the Yomi Yomi Fruit. He drifted alone for 50 years until meeting Luffy and joining his crew.",
            ...
            devilFruit: "no devil fruit powers or Haki, but due to his bionic modifications he has superhuman strength and resilience to damage. Furthermore, he has an arsenal of weapons at his disposable that are part of his cyborg modifications.",
